...
// A wrapper for HomeScreen that handles:
// -  constraining the app font size scaling factor to prevent too big or too
//    small fonts
// -  setting the callback for a click on the local notification generated by a
//    firing reminder.
...
class _StreamBuilderBody extends StatelessWidget {
  final double _bottomPadding = 56;
            ...
            if (pinnedNotes.isEmpty) {
              return Container(
                ...
                child: (modeNotifier.mode == NoteCardMode.extended)
                    ? DismissibleExtendedModeList(
                        notes: unpinnedNotes, bloc: homeBloc)
                    : DismissibleSmallModeGrid(
                        notes: unpinnedNotes,
                        bloc: homeBloc,
                      ),
              );
              ...
              child: Column(
                children: <Widget>[
                  ...
                  (modeNotifier.mode == NoteCardMode.extended)
                      ? DismissibleExtendedModeList(
                          notes: pinnedNotes, bloc: homeBloc)
                      : DismissibleSmallModeGrid(
                          notes: pinnedNotes,
                          bloc: homeBloc,
                        ),
